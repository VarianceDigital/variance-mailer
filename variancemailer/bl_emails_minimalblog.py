...
bp = Blueprint('bl_emails_minimalblog', __name__, url_prefix='/emailservice-blog')
...
def send_signup_email(user_email, user_aut_key,email_link_url, email_link_token):
    ...
    sender_name = "Donatella Nani - Attitude" #os.environ.get('SENDER_NAME')
    ...
    recipient_name = 'Attitude user'

    # subject
    subject = 'Confirm and access for Attitude'

    # text body
    body_plain = ("Hi there,\n"
        "please cut and paste link below to confirm your Attitude registration!\n"
    ...
    body_html = f'''<html>
                        ...
                        <body>
                            <p>Hi there, </p>
                            <p>please click on the link below to confirm your <i>Attitude</i> registration<br>
...
def send_change_email(user_email, user_aut_key,email_link_url, email_link_token):
    ...
    # text body
    body_plain = ("Hi there,\n"
        "please cut and paste link below to confirm your Attitude changed email!\n"
        + email_link_url + email_link_token + "\n\n"
    ...
    body_html = f'''<html>
                        ...
                        <body>
                            <p>Hi there, </p>
                            <p>please click on the link below to confirm your <i>Attitude</i> changed email<br>
                            <a href="{email_link_url + email_link_token}"><b>Confirm email</b></a>
                            </p><br>
                            <p>To login, use your email along with this access key:<br>
                            {user_aut_key}
...
def send_reset_email(user_email, user_otp):
    ...
    # subject
    subject = 'Reset access key for Minimal+User'

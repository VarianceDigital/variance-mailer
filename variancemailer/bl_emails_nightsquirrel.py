...
def _send_notification_email(recipient_email, recipient_name, subject, body_plain, body_html):
    """Shared SMTP send logic for notification emails."""
    mailertogo_host     = os.environ.get('MAILERTOGO_SMTP_HOST')
    mailertogo_port     = os.environ.get('MAILERTOGO_SMTP_PORT', 587)
    mailertogo_user     = os.environ.get('MAILERTOGO_SMTP_USER')
    mailertogo_password = os.environ.get('MAILERTOGO_SMTP_PASSWORD')
...
def send_answer_delivered_email(data):
    ...
    return _send_notification_email(recipient_email, user_name, subject, body_plain, body_html)
...
def send_payer_quote_accepted_email(data):
    ...
    return _send_notification_email(recipient_email, payer_name, subject, body_plain, body_html)
...
def send_payment_failed_email(data):
    ...
    return _send_notification_email(recipient_email, "Admin", subject, body_plain, body_html)

...
bp = Blueprint('bl_emails_minimaluser', __name__, url_prefix='/emailservice-usr')
...
def send_signup_email(user_email, user_aut_key,email_link_url, email_link_token):
    ...
    recipient_name = 'Minimal+User user'

    # subject
    subject = 'Confirm and access Minimal+User'

    # text body
    body_plain = ("Hi there,\n"
        "please cut and paste link below to confirm your Minimal+User registration!\n"
    ...
    body_html = f'''<html>
                        ...
                        <body>
                            <p>Hi there, </p>
                            <p>please click on the link below to confirm your <i>Minimal+User</i> registration<br>
...
def send_change_email(user_email, user_aut_key,email_link_url, email_link_token):
    ...
    # text body
    body_plain = ("Hi there,\n"
        "please cut and paste link below to confirm your Minimal+User changed email!\n"
        + email_link_url + email_link_token + "\n\n"
    ...
    body_html = f'''<html>
                        ...
                        <body>
                            <p>Hi there, </p>
                            <p>please click on the link below to confirm your <i>Minimal+User</i> changed email<br>
                            <a href="{email_link_url + email_link_token}"><b>Confirm email</b></a>
                            </p><br>
                            <p>To login, use your email along with this access key:<br>
                            {user_aut_key}
